...
const AviationInsights_Page = () => {
  return (
    <div>
      ...
      <div className="section-padding-x py-16 flex flex-col md:flex-row items-center justify-center gap-8">
        <Link
          to="/aviation-advice"
          className="relative w-full md:w-1/2 overflow-hidden rounded-xl shadow-md group"
        >
          <img
            src={aviationinsights1}
            alt=""
