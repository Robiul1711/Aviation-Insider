...
const AviationAdviceDetails = () => {
  ...
  return (
    <div>
      {/* Hero Banner */}
      <CommonBanner
        image={adviceDetails?.data?.data?.image}
      ...
      <div className="section-padding-x py-10 md:py-16 max-w-7xl mx-auto ">
        ...
        <div className=" max-w-none text-gray-800 sm:bg-[#F9FAFB] sm:rounded-xl sm:p-6">
          ...
          <p
            ...
            dangerouslySetInnerHTML={{
              __html: adviceDetails?.data?.data?.long_description,
            }}
          ></p>
        </div>
      </div>
