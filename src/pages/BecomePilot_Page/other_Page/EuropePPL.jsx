...
const EuropePPL = () => {
  ...
  const {data:EuPPl,isLoading} = useQuery({
    queryKey: ["EuPPl"],
    queryFn: async () => {
      const res = await axiosPublic.get("/course-category/details/course/europe-ppl", {
        params: {
          page: pageCount,
        },
      });
  ...
  return (
    <div>
      ...
      <div className="section-padding-x">
        ...
        <UKPPLCourses data={EuPPl} isLoading={isLoading} />
              {/* Pagination */}
      <div className="flex py-10 justify-center">
        <ReactPaginate
          breakLabel="..."
          pageCount={EuPPl?.data?.meta?.last_page || 1}
