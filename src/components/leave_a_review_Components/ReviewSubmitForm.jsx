...
export default function ReviewSubmitForm() {
  ...
  // Numeric course IDs for backend
  const courseOptions = [
  ...
  return (
    <div className="border rounded-md mt-5 md:mt-10 p-4 md:p-6">
      ...
      <div className="space-y-6">
        {/* Review Text Area */}
        <div>
          <label className="block font-medium text-gray-800 mb-3">Write your review</label>
          <textarea
            {...register('message')}
            rows={8}
      ...
      <div className="py-5">
        <p>
          You now have the opportunity to write about your experience at this ATO. A balanced review
          of both positive and negative aspects of your training will be the most beneficial for
          future students. Pilot Network welcomes constructive criticism. You could talk about:
        </p>
        <ul className="mt-5 space-y-1 list-disc list-inside">
          ...
          <li>If you were successful in finding employment, and what support you received.</li>
