...
const StarRow = ({ label, value }) => (
  <div className="flex flex-col items-center bg-white border p-4 rounded-lg w-full sm:w-[48%] md:w-[31%] lg:w-[22%] min-w-[150px] transition-shadow hover:shadow-md">
...
const ReviewViewPage = () => {
  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row section-padding-x py-12 gap-10">
        {/* Main Section */}
        <div className="w-full lg:w-3/4 ">
          {/* Tab Navigation */}
          <div className="flex flex-wrap items-center gap-4 mb-6 border-b pb-2 font-bold text-sm sm:text-base">
            <Link
              to="/review-view"
              className={`${
                isViewActive
        ...
        {/* Sidebar */}
        <div className="w-full lg:w-1/4 px-4 sm:px-0">
