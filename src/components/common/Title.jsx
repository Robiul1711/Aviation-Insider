...
const sizeMap = {
  ...
  title56: "text-[34px] sm:text-[56px] font-bold",
  title48: "text-xl font-semibold",
  title40: "text-xl xl:text-[40px] font-medium",
  title32: "xl:text-[32px]  font-medium",
  title28: "text-xl xlg:text-[28px] font-medium",
  title24: "text-bsse lg:text-[24px]  font-medium",
  title22: "lg:text-base xl:text-[22px] font-medium",
  title20: " text-base  xl:text-xl font-normal",
  title18: "text-sm sm:text-lg  font-normal",
