...
const EuropeDetail = () => {
  return (
    <div className='bg-[#E6E8EC] pt-16'>
      <Title level="title20" className="text-black text-center section-padding-x">
...
<p className='text-white'>Also visit our <span className='text-Primary'>Enhanced Flight Schools</span> page for more detailed profiles to aide in your search: <a href='https://pilot-network.com/plus-schools' className='text-Primary hover:underline'>https://pilot-network.com/plus-schools</a></p>
      </div>
    </div>
  )
}
